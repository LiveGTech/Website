...
* <a href="/media/blog/pr-multiplatform-os/presskit.zip" download="Press kit - LiveG OS multiplatform support.zip">Press kit (contains press release and images)</a> (.zip file)
